...
\multirow{3}{*}{Small}  & 0.73 & 0.91 & 
							...
							\multirow{3}{*}{0.3} & \multirow{3}{*}{0.3} & & \\ \cline{2-3} \cline{8-10} 
                        & 0.85 & 0.85 & & & & & & \\ \cline{2-3} \cline{8-10}
                        & 0.88 & 0.90 & & & & & & \\ \hline
\multirow{3}{*}{Medium} & 0.43 & 0.67 & 
							\multirow{3}{*}{0.49} & \multirow{3}{*}{text} &
							\multirow{3}{*}{0.3} & \multirow{3}{*}{0.3} &
						    & & \\ \cline{2-3} \cline{8-10} 
                        & 0.48 & 0.33 & & & & & & \\ \cline{2-3} \cline{8-10}
                        & 0.55 & 0.48 & & & & & & \\ \hline
\multirow{3}{*}{Large}  & 0.32 & 0.34 &
							\multirow{3}{*}{} & \multirow{3}{*}{text} &
							\multirow{3}{*}{0.3} & \multirow{3}{*}{0.3} &
						    & & \\ \cline{2-3} \cline{8-10} 
                        & 0.34 & 0.41 & & & & & & \\ \cline{2-3} \cline{8-10}
                        & 0.36 & 0.39 & & & & & & \\ \hline
\end{tabular}
